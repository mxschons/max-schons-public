...
Current monthly / yearly thresholds by tier are in [budget.tsv](../budget.tsv).
...
## "Never need to work" target

Based on [Gerd Kommer's safe-withdrawal table](https://gerd-kommer.de/medien/svs-abod-2022-03.pdf). That table is in 10k/month units, so roughly half the fourth column covers my current spending (assuming insurances and investments level out). At my current age that's a net worth of ~3M over the next 10y.
